...
case 'DONE':
       if (!isGroup) return 
					if (!isGroupAdmins) return 
              quotedText = dev.message.extendedTextMessage.contextInfo.quotedMessage.conversation
               xdev.sendMessage(from, `_Pesanan_:\n${quotedText}\n\n_Status pesanan_ : *Terkirim*✅\n_Tanggal_ : *${calender}*\n_Jam_ : *${timeWib} WIB*\n\n*Pesanan @${mentionByReply.split("@")[0]} selesai*\n*Terimakasih telah order*`, MessageType.text, { quoted: setQuoted, contextInfo:{ mentionedJid:[mentionByReply]}})
...
case 'listadd':
	...
	xdev.sendMessage(from, `*Berhasil Menambahkan list ${q} ke menu*`, MessageType.text, { quoted: dev })
